 ...
 * Retrieves a specific scheduled X/Twitter post by ID
 */
 ...
 * Updates a scheduled X/Twitter post (only pending posts can be updated)
 *
 * Request body:
 ...
 * Permanently deletes a scheduled X/Twitter post
 */
