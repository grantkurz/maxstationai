 ...
 * Schedules a LinkedIn post for future publication
 *
 * Request body:
 ...
 * Retrieves scheduled posts for the authenticated user
 *
 * Query parameters:
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Get all scheduled posts for user (optionally filtered by status)
    else {
      scheduledPosts = await scheduledPostService.getUserScheduledPosts(
        user.id,
        statusParam || undefined
      );
    }
